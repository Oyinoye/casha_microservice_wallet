...
export class Config {
    ...
    'jhipster.mail.from' = 'wallet@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'wallet API';
    'jhipster.swagger.description' = 'wallet API documentation';
    ...
    'eureka.instance.appname' = 'wallet';
    'eureka.instance.instanceId' = 'wallet:${random.value}';
