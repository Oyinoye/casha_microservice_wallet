...
export class CustomerDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('walletApp.customer.delete.question'));
...
export default class CustomerComponentsPage {
  ...
  async deleteCustomer() {
    ...
    expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/walletApp.customer.delete.question/);
