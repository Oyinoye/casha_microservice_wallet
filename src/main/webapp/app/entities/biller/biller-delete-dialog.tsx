...
export interface IBillerDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const BillerDeleteDialog = (props: IBillerDeleteDialogProps) => {
  useEffect(() => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="walletApp.biller.delete.question">
        <Translate contentKey="walletApp.biller.delete.question" interpolate={{ id: billerEntity.id }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(BillerDeleteDialog);
